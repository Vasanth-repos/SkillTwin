          ...
          {!isExpanded ? (
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-rose-600 to-amber-600 text-white font-bold transition-transform hover:scale-105 shadow-md"
              >
                <Play className="w-3.5 h-3.5 fill-white" />
                <span>5-Min Video Pitch</span>
              </button>
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {/* 5-Minute Video Pitch Quick Trigger */}
              <button
                onClick={() => setShowPitchModal(true)}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-rose-600 via-pink-600 to-amber-600 hover:from-rose-500 hover:to-amber-500 text-white font-black text-[11px] shadow-lg shadow-rose-600/30 transition-all hover:scale-105"
              >
                <Play className="w-3.5 h-3.5 fill-white" />
                <span>5-Min Video Pitch</span>
              </button>
              ...
              <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-brand-500/10 border border-brand-500/20 text-brand-300 font-bold text-[11px]">
                <Sparkles className="w-3.5 h-3.5 text-brand-400" />
                <span className="hidden sm:inline">1-Click Personas:</span>
              </div>
